...
# Initial price of $PX (in USD)
INITIAL_PX_PRICE = 0.30
...
# Function to get emoji indicator (📈 or 📉)
def get_emoji_indicator(percentage_change):
    if percentage_change >= 0:
        return "📈"  # Upwards trend
    else:
        return "📉"  # Downwards trend
    ...
    while True:
        ...
        if px_price is not None and ton_price is not None:
            ...
            if previous_ton_price is not None:
                ...
                ton_emoji = "📉"  # Default emoji for the first run
            ...
            if previous_px_price is not None:
                ...
                if abs(px_price_change) >= 5:
                    ...
                    alert_message = f"🚨 $PX Price Alert: {px_price_change:.2f}% {alert_emoji}!"
